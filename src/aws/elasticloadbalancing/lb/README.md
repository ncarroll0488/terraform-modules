...
| <a name="input_listeners"></a> [listeners](#input\_listeners) | Configuration for listeners | <pre>map(object({<br/>    alpn_policy                   = optional(string, null),<br/>    certificate_arn               = optional(string, null),<br/>    listener_port                 = number,<br/>    listener_protocol             = string,<br/>    default_response_content_type = optional(string, "text/plain"),<br/>    default_response_content      = optional(string, "Hello, world!"),<br/>    default_response_status       = optional(string, "200"),<br/>    nlb_target_group              = optional(string)<br/>  }))</pre> | `{}` | no |
