...
variable "nacl_rules" {
  type        = map(any)
  default     = {}
  description = "Custom NACL rules. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl_rule for parameters. Set type = `\"ingress\"` for ingress rules, otherwise they're egress"
}
